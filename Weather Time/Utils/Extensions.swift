...
//  Story Time
//
//  Created by SEAN BLAKE on 12/17/23.
//
...
extension Color {
    ...
    static let navBarBackround = LinearGradient(gradient: Gradient(colors: [Color("Background 1").opacity(0.1), Color("Background 2").opacity(0.1)]), startPoint: .topLeading, endPoint: .bottomTrailing)
    ...
    static let bottomSheetBorderMiddle = LinearGradient(gradient: Gradient(colors: [.white.opacity(0), .white.opacity(0.5), .white.opacity(0)]), startPoint: .top, endPoint: .bottom)
    static let bottomSheetBorderTop = LinearGradient(gradient: Gradient(stops: [.init(color: .white, location: 0), .init(color: .clear, location: 0.2)]), startPoint: .leading, endPoint: .trailing)
    ...
    static let tab_BarBorder = Color("Tab Bar Border").opacity(0.5)
    
    static let forecast_CardBackground = Color("Forecast Card Background")
    
    static let probability_text = Color("Probability Text")
}
