    ...
    var body: some View {
        ZStack {
            ...
            RoundedRectangle(cornerRadius: 30)
                .fill(Color.forecast_CardBackground.opacity(isActive ? 1 : 0.2))
            ...
            // MARK: Content
            VStack(spacing: 16) {
                Text(forecast.date, format: forecastPeriod == ForecastPeriod.hourly ? .dateTime.hour() : .dateTime.week())
